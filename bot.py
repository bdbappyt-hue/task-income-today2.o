...
# CONFIG
# ==============================
TOKEN = os.getenv("BOT_TOKEN", "7634035485:AAFstifAHD82NVziKXymGFot2wmpCNJsZHo")
...
def webhook():
    bot.remove_webhook()
    bot.set_webhook(url="https://task-income-today2-o-1.onrender.com/7634035485:AAFstifAHD82NVziKXymGFot2wmpCNJsZHo" )
